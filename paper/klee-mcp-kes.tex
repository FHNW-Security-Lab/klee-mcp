...
%% Procedia papers conventionally have the frontmatter (title +
%% authors + abstract + keywords + corresponding-author footnote +
%% page-1 copyright line) on page 1 alone, with the body of the
%% manuscript starting on page 2. Forcing the page break here avoids
%% the introduction running into the page-1 footer area.
\newpage
